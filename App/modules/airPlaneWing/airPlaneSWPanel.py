...
# Import de freecad_imports depuis le répertoire racine
import sys
import os

# Ajouter le chemin racine au PYTHONPATH (remonte 4 niveaux)
...
try:
    ...
    from freecad_imports import App, Gui, Vector, Console, FreeCAD, FreeCADGui, Part

from App.modules.airPlaneRib.airPlaneRib import WingRib, ViewProviderWingRib
from PySide import QtCore
import math

# Chemin vers les icônes dans le répertoire racine du workbench (remonte 4 niveaux)
...
class WingSPanel:
    def __init__(
        ...
        obj.addProperty(
            ...
            "RootRib",
            "Rib",
            QtCore.QT_TRANSLATE_NOOP("App::Property", "Root Rib of the panel"),
        ).RootRib = _rootRib  # .rootRib-_rootRib
        obj.addProperty(
            "App::PropertyLink",
            "TipRib",
            "Rib",
            QtCore.QT_TRANSLATE_NOOP("App::Property", "Tip Rib of the panel"),
        ).TipRib = _tipRib  # .tipRib-_tipRib
