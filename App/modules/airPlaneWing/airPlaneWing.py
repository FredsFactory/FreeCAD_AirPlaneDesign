...
try:
    ...
    from freecad_imports import App, Gui, Vector, Console, Units
except ImportError:
...
# Chemin vers les icônes dans le répertoire racine du workbench (remonte 4 niveaux: airPlaneWing → modules → App → AirPlaneDesign)
...
class Wing:
    def __init__(self, obj, _wPanels):
        ...
        obj.addProperty(
            ...
            "WingEdges",
            "Wing",
            QtCore.QT_TRANSLATE_NOOP("App::Property", "WingEdges"),
        )  # .leadInEdges
        ...
        obj.addProperty(
            ...
            "WingRootChoord",
            "Wing",
            QtCore.QT_TRANSLATE_NOOP("App::Property", "Wing Tip Choord"),
        )
        obj.addProperty(
            "App::PropertyLength",
            "WingTipChoord",
...
class WingTaskPanel:
    ...
    def __init__(self, vobj):
        ...
        path_to_ui = (
            ...
            + "Mod/AirPlaneDesign/resources/airPlaneWpanelTask.ui"
        )
    ...
    def update(self, vobj):
        ...
        for wpanel in vobj.Object.WingPanels:
            initPanelTable.append(
                [wpanel.Base.Label, wpanel.Base.RibProfil, wpanel.PanelLength, 0, 0]
            )
            i += 1
        # initPanelTable = [
    ...
    def GetResources(self):
        ...
        return {
            ...
            "MenuText": QtCore.QT_TRANSLATE_NOOP(
                "Create_a_wing", "Create/Add a wing to plane, select a plane and clic"
            ),
        }
