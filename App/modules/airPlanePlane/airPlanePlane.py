...
# Chemin vers les icônes dans le répertoire racine du workbench (remonte 4 niveaux: airPlanePlane → modules → App → AirPlaneDesign)
...
class Plane:
    def __init__(self, obj):
        ...
        obj.addProperty(
            ...
            "fuselageLength",
            "fuselage",
            QtCore.QT_TRANSLATE_NOOP("App::Property", "Fuselage Length"),
        )
        obj.addProperty(
            "App::PropertyLength",
            "fuselageHeight",
            "fuselage",
            QtCore.QT_TRANSLATE_NOOP("App::Property", "Fuselage Height"),
        )
        obj.addProperty(
            "App::PropertyLength",
            "fuselageWidth",
            "fuselage",
            QtCore.QT_TRANSLATE_NOOP("App::Property", "Fuselage Width"),
        )
        ...
        obj.addProperty(
            ...
            "_3viewsFile",
            "fuselage",
            QtCore.QT_TRANSLATE_NOOP("App::Property", "3 Views file"),
        )
        ...
        obj.addProperty(
            ...
            "Wings",
            "Base",
            QtCore.QT_TRANSLATE_NOOP("App::Property", "List of wings"),
        )
...
class PlaneTaskPanel:
    ...
    def __init__(self, vobj):
        ...
        path_to_ui = (
            ...
            + "Mod/AirPlaneDesign/resources/airPlaneDesignEdit.ui"
        )
...
class ViewProviderPlane:
    def __init__(self, obj):
        ...
        obj.addProperty(
            "App::PropertyColor", "Color", "Wing", "Color of the wing"
        ).Color = (1.0, 0.0, 0.0)
        obj.Proxy = self
...
class CommandPlane:
    ...
    def GetResources(self):
        ...
        return {
            "Pixmap": iconpath,
            "MenuText": QtCore.QT_TRANSLATE_NOOP("Create_a_Plane", "Create a Plane"),
        }
