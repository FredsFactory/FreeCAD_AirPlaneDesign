...
def debug_module_icon_paths():
    ...
    sm_workbench_icons_path_plane = os.path.join(
        os.path.dirname(
    ...
    plane_icon = os.path.join(sm_workbench_icons_path_plane, "plane.png")
    ...
    sm_workbench_icons_path_wing = os.path.join(
        os.path.dirname(
    ...
    wing2_icon = os.path.join(sm_workbench_icons_path_wing, "wing2.png")
    ...
    sm_workbench_icons_path_wpanel = os.path.join(
        os.path.dirname(
    ...
    panel_icon = os.path.join(sm_workbench_icons_path_wpanel, "panel.png")
