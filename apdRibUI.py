...
#*                                                                         *
#*   Module : apdRibUI.py                                                  *
#*   Handle the graphics for the rib design.                               *
#*                                                                         *
#*   Dependencies :                                                        *
...
from apdLibShapes import generateNacaCoords
from apdLibShapes import readPointsOnFile
...
class SelectObjectUI():
    def __init__(self):
        ...
        profil_dir=os.path.join(wb.base_path, 'wingribprofil') 
